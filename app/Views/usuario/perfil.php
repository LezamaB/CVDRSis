            ...
            <div class="card card-primary card-outline">
                <div class="card-body box-profile">
                    <div class="text-center">
                        <img class="profile-user-img img-fluid img-circle" src="<?= $foto_usuario ?>"
                                    ...
                                    <?= form_open_multipart("actualizar_mi_perfil", ['id' => 'form-mi-perfil'])?>
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <center>
                                                        <img src="<?= $foto_usuario ?>" class="img-rounded" alt="" id="img-preview" name="img-preview" width="15%" style="margin-bottom: 10px;">
                                                        <?php
                                                            $data = array(
                                                                'type' => 'hidden',
                                                                'name' => 'foto_anterior',
...
<script src=<?= base_url(ESPECIFICOS.'perfil.js')?>></script>
<script src=<?= base_url(GLOBALES.'funciones.js')?>></script>
