...
<div class="container-fluid">
                ...
                <div class="col-md-12">
                    ...
                    <?= form_open_multipart('editar_conferencia',['id'=>'form-conferencia','class'=>''])?>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <center>
                                    <?php
                                        $foto_plantilla = (!is_null($conferencias->plantilla_imagen)) ? base_url(RECURSOS_IMAGENES_CERTIFICADO."/".$conferencias->plantilla_imagen) :
                                         base_url(RECURSOS_IMAGENES_CERTIFICADO."reconocimiento.png");
                                    ?>                                      
                                    <img src="<?= $foto_plantilla;?>" class="img-rounded" alt="" id="img-preview" width="50%" style="margin-bottom: 10px;">
                                    
                                    <?php
                                        //Capturamos el id_conferencia a editar
                                        $data = array(
                                            'type' => 'hidden',
                                            'name' => 'id_conferencia',
                                            'class' => 'form-control',
                                            'id' => 'id_conferencia',
                                            'value' => $conferencias->id_conferencia
                                        );
                                        echo form_input($data);

                                        if(!is_null($conferencias->plantilla_imagen)){
                                            $data = array(
                                                'type' => 'hidden',
                                                'name' => 'foto_anterior',
                                                'class' => 'form-control',
                                                'id' => 'foto_anterior',
                                                'value' => $conferencias->plantilla_imagen
                                            );
                                            echo form_input($data);
                                        }
                                    ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php
                                             $data = [
                                                ...
                                                'class' => 'form-control',
                                                'maxlength' => '100',
                                                'value'=>$conferencias->nombre_conferencia,
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php
                                             $data = [
                                                ...
                                                'class' => 'form-control',
                                                'maxlength' => '100',
                                                'value'=>$conferencias->descripcion,
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php
                                             $data = [
                                                ...
                                                'class' => 'form-control',
                                                'maxlength' => '100',
                                                'value'=>$conferencias->fecha_conferencia,
                                                'requiered'=>true
                                            ];
                                            echo form_input($data);
                                        ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php
                                             $data = [
                                                ...
                                                'class' => 'form-control',
                                                'maxlength' => '100',
                                                'value'=>$conferencias->hora_conferencia,
                                                'requiered'=>true
                                            ];
                                            echo form_input($data);
                                        ?>
