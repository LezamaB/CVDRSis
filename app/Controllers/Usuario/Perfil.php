    ...
    class Perfil extends BaseController{
        ...
        public function __construct(){
            ...
            if (comprobar_acceso(TAREA_PERFIL)) {
                ...
                $session->modulo_permitido = FALSE;
            }//end else
        }//end constructor
        ...
        public function index() {
            ...
            if($this->permitido){
                return $this->crear_vista('usuario/perfil',$this->cargar_datos());            
            }//end else
            else{
        ...
        */
        public function actualizar_perfil() {
            ...
            if(!empty($this->request->getFile('foto_perfil')) && $this->request->getFile('foto_perfil')->getSize() > 0){
                $this->eliminar_archivo(RECURSOS_IMAGENES_USUARIO, $this->request->getPost('foto_anterior'));
